    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#f7f8fc",minHeight:"100vh",color:"#1a1a2e"}}>
      ...
      <div className="no-print" style={{position:"fixed",left:0,top:0,bottom:0,width:214,background:"#0f172a",display:"flex",flexDirection:"column",zIndex:200,transform:isMob()?(sideOpen?"translateX(0)":"translateX(-100%)"):"translateX(0)",transition:"transform .22s ease"}}>
        <div style={{padding:"16px",borderBottom:"1px solid #1e293b",display:"flex",justifyContent:"center",alignItems:"center",minHeight:78}}>
          <img src={`data:image/png;base64,${LOGO_B64}`} alt="Boreal" style={{height:46,maxWidth:148,objectFit:"contain"}} onError={e=>{e.target.style.display="none";}}/>
        </div>
    ...
    <Modal onClose={onClose} maxWidth={780}>
      ...
      <div style={{marginBottom:10}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
          ...
          <button onClick={()=>setShowMargen(v=>!v)} style={{fontSize:10,color:showMargen?"#1d4ed8":"#94a3b8",background:"none",border:"none",cursor:"pointer"}}>
      ...
      {total>0&&(
        <div style={{display:"flex",justifyContent:"flex-end",marginBottom:10}}>
          <div style={{width:226,background:"#f8fafc",borderRadius:8,padding:"10px 13px"}}>
            ...
            <div style={{display:"flex",justifyContent:"space-between",fontSize:14,fontWeight:700,color:"#1d4ed8",borderTop:"1px solid #e2e8f0",paddingTop:5}}><span>Total</span><span>{fmt(total)}</span></div>
