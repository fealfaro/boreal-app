...
function ModuloMaestros({proveedores,setProv,empresas,setEmpresas,bodegas,setBodegas,cots}) {
  ...
  const SECS=[
    {id:"proveedores",label:"Proveedores",icon:"prov",items:proveedores,set:setProv},
    {id:"organismos",label:"Organismos compradores",icon:"org",items:empresas,set:setEmpresas},
    {id:"bodegas",label:"Bodegas",icon:"bod",items:bodegas,set:setBodegas},
  ];
    ...
    <div style={{maxWidth:700}}>
      ...
      <div style={{display:"flex",gap:2,marginBottom:18,background:"#f1f5f9",borderRadius:10,padding:4,width:"fit-content"}}>
        {SECS.map(s=>(
          ...
          }}>{s.label} <span style={{color:"#94a3b8",fontWeight:400}}>({s.items.length})</span></button>
        ))}
      </div>
