...
export const ESTADO_COLORS = {
  ...
  Adjudicada:    {bg:"#dcfce7",text:"#15803d"},
  Rechazada:     {bg:"#fee2e2",text:"#b91c1c"},
  Facturada:     {bg:"#fef9c3",text:"#854d0e"},
...
export const EMPRESA_INFO = {
  ...
  fono:"+56 9 8501 9647",ejecutivo:"Felipe Alfaro",cargo:"Ejecutivo Comercial",
};
export const CATEGORIAS_GASTO = ["Transporte","Software","Arriendo","Marketing","Contabilidad","Comunicaciones","Otros"];
